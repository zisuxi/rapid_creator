...
@section('script')
    <script>
        ...
        function calculatePosition(text) {
            ...
            const scaleInputHeight = inputRect.height / (image[0].naturalHeight * scaleHeight);
            const originalInputHeight = inputRect.height / scaleInputHeight;
            const fontSize = parseInt(input.css('font-size'));
            adjustedPositionY += originalInputHeight;
            return {
                x: adjustedPositionX,
                y: adjustedPositionY,
                fontSize: fontSize,
