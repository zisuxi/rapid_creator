                        ...
                        <div class="col-lg-6 col-xl-6 col-md-6" id="getting_preview">
                            <div class="card custom-card bg-dark">
                                <div class="card-body pt-9 pb-0">
                                    <div id="screenshoot" class="bg-dark">
    ...
    @section('script')
        ...
        <script>
            ...
            function captureScreenshot() {
                let gettingImageDiv = document.getElementById('previewImage');
                let divToCapture = document.getElementById('screenshoot');
                if (gettingImageDiv && divToCapture) {
                    html2canvas(divToCapture).then(function(canvas) {
                        gettingImageDiv.innerHTML = '';
                        gettingImageDiv.appendChild(canvas);
                    });
                } else {
