                                            ...
                                            <tr
                                                ...
                                                <td class="content-block" itemprop="handler" itemscope
                                                    ...
                                                    <a href="{{ url('/reset-password/' . $body) }}"
                                                        style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: .8125rem; color: #FFF; text-decoration: none; font-weight: 400; text-align: center; cursor: pointer; display: inline-block; border-radius: .25rem; text-transform: capitalize; background-color: #2E4374; margin: 0; border-color: #2E4374; border-style: solid; border-width: 1px; padding: .5rem .9rem;cursor:pointer;">Reset
                                                        Password</a>
                                                </td>
                                            </tr>
                                            <tr
                                                ...
                                                <td class="content-block"
                                                    ...
                                                    <p style="color: #878a99;">Please send and feedback or bug info to
                                                        <a href="https://pod.ibexstack.com/"
                                                            style="font-weight: 500px;">pod.ibexstack.com</a>
                                                    </p>
                                                    <p
                                                        style="font-family: 'Roboto', sans-serif; font-size: 14px;color: #98a6ad; margin: 0px;">
                                                        2022 Print On Demand. Design & Develop by ibexstack</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
