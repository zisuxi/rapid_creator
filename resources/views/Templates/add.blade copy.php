            ...
            <div id="kt_app_content" class="app-content  flex-column-fluid ">
                <div id="kt_app_content_container" class="app-container  container-xxl">
                    <div class="row d-flex">
                        ...
                        <div class="col-lg-6 col-xl-6 col-md-6" style="display: block" id="image_processing">
                                    ...
                                    <form id="form_submit" data-parsley-validate="">
                                        <div class="">
                                            <div class="row mt-5">
                                                ...
                                                <div class="fv-row mb-7">
                                                    <label for="fs-6 fw-semibold mb-2">Choose Text Color</label>
                                                    <br>
                                                    <img style="min-width:16px;min-height:16px;box-sizing:unset;box-shadow:none;background:unset;padding:0 6px 0 0;cursor:pointer;"
                                                        ...
                                                        class="colorpick-eyedropper-input-trigger"><input
                                                        class="form-control" type="color" value="#563d7c"
                        ...
                        <div class="col-lg-6 col-xl-6 col-md-6" id="getting_preview">
                            <div class="card custom-card bg-dark">
                                <div class="card-body pt-9 pb-0" style="background-color: #31304D">
                                ...
                                <div class="card-footer p-3 text-center bg-light" id="preview_image"
                                    style="display: none;background-color: #bcbfc5;border-bottom-right-radius: 8px;border-bottom-left-radius: 8px;">
